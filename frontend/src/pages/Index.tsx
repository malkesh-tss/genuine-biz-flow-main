            ...
            <div className="max-w-lg sm:max-w-2xl mx-auto">
              ...
              {submitted ? (
                <div className="text-center py-12 sm:py-16 md:py-20 opacity-0 animate-fade-up" style={{ animationDelay: "0s" }}>
                  ...
                  <p className="text-sm sm:text-base md:text-lg text-muted-foreground font-body">We'll send you the Zoom link before the event. See you on <bold>April 29th</bold>!</p>
                </div>
              ) : (
