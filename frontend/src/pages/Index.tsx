...
const features = [
  {
    ...
    description:
      "We get right to the point. No fluff, no filler- just meaningful introductions and real conversations.",
  },
  {
    icon: Users,
    title: "High-Quality Connections",
    description:
      "Business owners, not browsers. Every attendee is a decision-maker ready to connect and collaborate.",
  },
  {
    icon: Shield,
    title: "Zero Cost",
    description:
      "Completely free. Just show up ready to connect with like-minded professionals.",
  },
];
    ...
    <>
      ...
      <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <section className="relative min-h-screen sm:min-h-[90vh] md:min-h-screen flex items-center gradient-navy overflow-hidden pt-16 sm:pt-20 md:pt-24">
          ...
          <div
            className="absolute bottom-10 sm:bottom-16 md:bottom-20 right-2 sm:right-6 md:right-10 w-48 sm:w-64 md:w-72 lg:w-96 h-48 sm:h-64 md:h-72 lg:h-96 bg-gold/5 rounded-full blur-2xl sm:blur-3xl animate-pulse"
          ...
          <div className="container mx-auto relative z-10 px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-24">
            <div className="max-w-4xl lg:max-w-5xl mx-auto text-center">
              ...
              <div className="inline-flex items-center gap-2 rounded-full border border-gold/30 bg-gold/10 px-3 sm:px-5 md:px-6 py-1.5 sm:py-2 md:py-2.5 mb-6 sm:mb-8 md:mb-10 animate-fade-up shadow-lg shadow-gold/10">
                ...
                <span className="text-xs sm:text-sm md:text-base font-body font-medium text-gold-light">
              ...
              {/* Main Headline */}
              <h1
                className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-display font-bold text-primary-foreground leading-tight mb-4 sm:mb-6 md:mb-8 text-shadow-hero animate-fade-up"
              ...
              {/* Subheading */}
              <p
                className="text-base sm:text-lg md:text-xl lg:text-2xl text-primary-foreground/80 font-body max-w-2xl sm:max-w-3xl mx-auto mb-8 sm:mb-10 md:mb-12 opacity-0 animate-fade-up leading-relaxed"
              ...
              {/* CTA Button */}
              <div
                className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center opacity-0 animate-fade-up mb-10 sm:mb-14 md:mb-16"
              ...
              {/* Event Details Grid */}
              <div
                className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 md:gap-6 opacity-0 animate-fade-up max-w-5xl mx-auto"
                style={{ animationDelay: "0.55s" }}
              >
                {details.map((d) => (
                  <div
                    key={d.label}
                    className="glass-card rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 text-center hover:bg-white/10 transition-all duration-300 backdrop-blur-sm"
                  >
                    <d.icon className="h-5 sm:h-6 md:h-8 w-5 sm:w-6 md:w-8 text-gold mx-auto mb-2 sm:mb-3 md:mb-4" />
                    <p className="text-[11px] xs:text-xs sm:text-sm md:text-base text-primary-foreground/60 font-body uppercase tracking-widest mb-1 sm:mb-2">
                      {d.label}
                    </p>
                    <p className="text-xs sm:text-sm md:text-lg font-semibold text-primary-foreground font-body">
                      {d.value}
                    </p>
                  </div>
                ))}
        ...
        <section className="py-12 sm:py-16 md:py-24 lg:py-32 bg-background relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10 sm:mb-14 md:mb-20">
              <p className="text-xs sm:text-sm md:text-base font-semibold tracking-widest uppercase text-accent mb-2 sm:mb-4 font-body">
                What to Expect
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-6xl mx-auto">
              {features.map((f, i) => (
                ...
                >
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl font-display font-bold text-foreground mb-2 sm:mb-3 md:mb-4 relative z-10">
                    {f.title}
                  </h3>
                  <p className="text-sm sm:text-base md:text-lg text-muted-foreground font-body leading-relaxed relative z-10">
                    {f.description}
                  </p>
                </div>
              ))}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl md:max-w-4xl mx-auto text-center">
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-primary-foreground/75 font-body leading-relaxed mb-6 sm:mb-8 md:mb-10">
                Whether you're looking for partnerships, clients, or just smart
                conversations, this session is designed to create meaningful
            ...
            <div className="max-w-6xl lg:max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center">
                ...
                <div className="relative flex justify-center lg:justify-start order-2 lg:order-1">
                  <div className="relative w-full max-w-sm">
                    ...
                    <div className="absolute -bottom-3 sm:-bottom-4 md:-bottom-5 -right-2 sm:-right-3 md:-right-5 bg-primary rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 shadow-xl border border-navy-mid">
                      <p className="text-lg sm:text-xl md:text-2xl text-gold font-display font-bold">
                        23+
                      </p>
                      <p className="text-xs sm:text-sm md:text-base text-primary-foreground/70 font-body">
                        Years Helping SMBs
                      </p>
                    </div>
                  </div>
                ...
                <div className="order-1 lg:order-2">
                  <p className="text-xs sm:text-sm md:text-base font-semibold tracking-widest uppercase text-accent mb-3 sm:mb-4 font-body">
                    Meet the Founder
                  </p>
                  <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display font-bold text-foreground mb-2 sm:mb-3">
                    Darrin Guttman
                  </h2>
                  <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gold font-display font-semibold mb-5 sm:mb-7 md:mb-8">
                    Founder & CEO, The Scale Summit
                  </p>
                  ...
                  <div className="space-y-3 sm:space-y-4 md:space-y-5 text-muted-foreground font-body leading-relaxed text-sm sm:text-base md:text-lg">
                    <p>
                      After more than twenty years helping established companies
                      scale, I realized the most overlooked group in business is
                      early-stage founders bootstrapping growth alone.
                    </p>
                    <p>
                      No one was addressing their real needs or guiding them
                      through what it takes to build a client acquisition plan
                      that turns confusion into confidence.
                    </p>
                    <p>That's why I started The Scale Summit.</p>
                    <p>
                      To change the small business world. To give business
                      owners a place built 100% for them. A place to learn,
                      engage, and gain clarity, direction, and confidence for
                      growth.
                    </p>
                    <p>We're not here to play small.</p>
            ...
            <div className="max-w-lg sm:max-w-2xl mx-auto">
              ...
              {submitted ? (
                ...
                >
                  ...
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-display font-bold text-foreground mb-2 sm:mb-3 md:mb-4">
                    You're In!
                  </h3>
                  <p className="text-sm sm:text-base md:text-lg text-muted-foreground font-body mb-4 sm:mb-6 md:mb-8">
                ...
                <form
                  ...
                  className="bg-card rounded-xl sm:rounded-2xl md:rounded-3xl border border-border shadow-2xl shadow-gold/5 p-5 sm:p-6 md:p-8 lg:p-10 space-y-4 sm:space-y-5 md:space-y-6 relative overflow-hidden"
                >
                  <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-gold to-transparent" />

                  {/* Full Name Field */}
                  <div>
                    <label className="block text-xs sm:text-sm md:text-base font-medium text-foreground mb-1.5 sm:mb-2 md:mb-3 font-body">
                      Full Name *
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, looking: e.target.value })
                      }
                    >
        ...
        <footer className="py-6 sm:py-8 md:py-10 lg:py-12 bg-card border-t border-border">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.p
                variants={fadeUp}
                className="text-muted-foreground/60 font-body text-xs sm:text-sm text-center"
              >
                © {new Date().getFullYear()} The Scale Summit. All rights
                reserved.
              </motion.p>
            </motion.div>
          </div>
